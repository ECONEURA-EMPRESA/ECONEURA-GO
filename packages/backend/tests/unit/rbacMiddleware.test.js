...
/* eslint-env jest */
const rbacMiddleware = require('../../src/api/http/middleware/rbacMiddleware');
describe('requireRoles middleware', () => {
    const createReqRes = (roles) => {
        const req = {
    ...
    it('debe devolver 401 si no hay authContext', () => {
        ...
        const mw = (0, rbacMiddleware_1.requireRoles)('admin');
        mw(req, res, next);
    ...
    it('debe permitir acceso si el usuario tiene un rol permitido', () => {
        ...
        const mw = (0, rbacMiddleware_1.requireRoles)('admin', 'user');
        mw(req, res, next);
