# FASE 14: Crear main.bicep orquestador
$ErrorActionPreference = "Stop"

Write-Host "☁️  Creando main.bicep orquestador completo..." -ForegroundColor Cyan
...
Set-Content "infrastructure/azure/main.bicep" $mainBicep

Write-Host "  ✅ main.bicep creado con orquestación completa" -ForegroundColor Green
Write-Host "`n✅ FASE 14 COMPLETADA: main.bicep orquestador" -ForegroundColor Green
